...
main(int argc, char **argv)
{
  ...
  4c:	84058593          	addi	a1,a1,-1984 # 888 <malloc+0xec>
  50:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 456:	4ae50513          	addi	a0,a0,1198 # 900 <digits>
 45a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 512:	39ac8c93          	addi	s9,s9,922 # 8a8 <malloc+0x10c>
 ...
 520:	3e4b8b93          	addi	s7,s7,996 # 900 <digits>
 ...
 646:	25e98993          	addi	s3,s3,606 # 8a0 <malloc+0x104>
        while(*s != 0){
 64a:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 728:	1f47b783          	ld	a5,500(a5) # 918 <freep>
 ...
 750:	00e6ea63          	bltu	a3,a4,764 <free+0x4a>
{
 ...
 792:	18f73523          	sd	a5,394(a4) # 918 <freep>
}
 796:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7c4:	15853503          	ld	a0,344(a0) # 918 <freep>
 ...
 7ec:	13090913          	addi	s2,s2,304 # 918 <freep>
  if(p == (char*)-1)
 7f0:	5afd                	li	s5,-1
 7f2:	a8a5                	j	86a <malloc+0xce>
    base.s.ptr = freep = prevp = &base;
 7f4:	00000797          	auipc	a5,0x0
 7f8:	12478793          	addi	a5,a5,292 # 918 <freep>
 7fc:	00000717          	auipc	a4,0x0
 800:	12470713          	addi	a4,a4,292 # 920 <base>
 804:	e398                	sd	a4,0(a5)
 806:	e798                	sd	a4,8(a5)
    base.s.size = 0;
 ...
 82c:	0ea73823          	sd	a0,240(a4) # 918 <freep>
      return (void*)(p + 1);
