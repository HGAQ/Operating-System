...
main(int argc, char **argv)
{
  ...
  4c:	84858593          	addi	a1,a1,-1976 # 890 <malloc+0xea>
  50:	4509                	li	a0,2
  52:	00000097          	auipc	ra,0x0
  56:	66e080e7          	jalr	1646(ra) # 6c0 <fprintf>
    exit(1);
  5a:	4505                	li	a0,1
...
000000000000040c <openat>:
.global openat
openat:
 li a7, SYS_openat
 40c:	03800893          	li	a7,56
 ecall
 410:	00000073          	ecall
 ret
 414:	8082                	ret
...
putc(int fd, char c)
{
 ...
 42c:	f14080e7          	jalr	-236(ra) # 33c <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 460:	4ac50513          	addi	a0,a0,1196 # 908 <digits>
 464:	883a                	mv	a6,a4
 ...
 484:	fec7f0e3          	bgeu	a5,a2,464 <printint+0x2c>
  if(neg)
 488:	00088c63          	beqz	a7,4a0 <printint+0x68>
    buf[i++] = '-';
 ...
 49c:	0028071b          	addiw	a4,a6,2
  ...
  while(--i >= 0)
 4a0:	02e05663          	blez	a4,4cc <printint+0x94>
 4a4:	fc040913          	addi	s2,s0,-64
 4a8:	993a                	add	s2,s2,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 51c:	398c8c93          	addi	s9,s9,920 # 8b0 <malloc+0x10a>
 ...
 52a:	3e2b8b93          	addi	s7,s7,994 # 908 <digits>
 ...
 592:	eaa080e7          	jalr	-342(ra) # 438 <printint>
 596:	8b4a                	mv	s6,s2
      } else {
 ...
 5ea:	e30080e7          	jalr	-464(ra) # 416 <putc>
  putc(fd, 'x');
 5ee:	07800593          	li	a1,120
 5f2:	8556                	mv	a0,s5
 5f4:	00000097          	auipc	ra,0x0
 5f8:	e22080e7          	jalr	-478(ra) # 416 <putc>
 5fc:	896a                	mv	s2,s10
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 ...
 63a:	de0080e7          	jalr	-544(ra) # 416 <putc>
          s++;
 ...
 650:	25c98993          	addi	s3,s3,604 # 8a8 <malloc+0x102>
        while(*s != 0){
 654:	85ee                	mv	a1,s11
 ...
 666:	db4080e7          	jalr	-588(ra) # 416 <putc>
 66a:	8b4a                	mv	s6,s2
      state = 0;
 66c:	4981                	li	s3,0
 ...
 678:	da2080e7          	jalr	-606(ra) # 416 <putc>
      state = 0;
 67c:	4981                	li	s3,0
 ...
 688:	d92080e7          	jalr	-622(ra) # 416 <putc>
        putc(fd, c);
 68c:	85ca                	mv	a1,s2
 68e:	8556                	mv	a0,s5
...
free(void *ap)
{
 ...
 732:	1f27b783          	ld	a5,498(a5) # 920 <freep>
 ...
 75a:	00e6ea63          	bltu	a3,a4,76e <free+0x4a>
{
 ...
 79c:	18f73423          	sd	a5,392(a4) # 920 <freep>
}
 7a0:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7c4:	00148a1b          	addiw	s4,s1,1
 7c8:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
 7ca:	00000517          	auipc	a0,0x0
 7ce:	15653503          	ld	a0,342(a0) # 920 <freep>
 ...
 7d4:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 7d6:	4798                	lw	a4,8(a5)
 7d8:	04977163          	bgeu	a4,s1,81a <malloc+0x74>
 7dc:	89d2                	mv	s3,s4
 7de:	000a071b          	sext.w	a4,s4
 7e2:	6685                	lui	a3,0x1
 7e4:	00d77363          	bgeu	a4,a3,7ea <malloc+0x44>
 7e8:	6985                	lui	s3,0x1
 7ea:	00098b1b          	sext.w	s6,s3
  p = sbrk(nu * sizeof(Header));
 7ee:	0049999b          	slliw	s3,s3,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
 ...
 7f6:	12e90913          	addi	s2,s2,302 # 920 <freep>
  if(p == (char*)-1)
 7fa:	5afd                	li	s5,-1
 7fc:	a8a5                	j	874 <malloc+0xce>
    base.s.ptr = freep = prevp = &base;
 7fe:	00000797          	auipc	a5,0x0
 802:	12278793          	addi	a5,a5,290 # 920 <freep>
 806:	00000717          	auipc	a4,0x0
 80a:	12270713          	addi	a4,a4,290 # 928 <base>
 80e:	e398                	sd	a4,0(a5)
 810:	e798                	sd	a4,8(a5)
    base.s.size = 0;
 812:	0007a823          	sw	zero,16(a5)
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 816:	87ba                	mv	a5,a4
 818:	b7d1                	j	7dc <malloc+0x36>
      if(p->s.size == nunits)
 81a:	02e48c63          	beq	s1,a4,852 <malloc+0xac>
        p->s.size -= nunits;
 81e:	4147073b          	subw	a4,a4,s4
 822:	c798                	sw	a4,8(a5)
        p += p->s.size;
 ...
 82c:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
 82e:	0147a423          	sw	s4,8(a5)
      freep = prevp;
 832:	00000717          	auipc	a4,0x0
 836:	0ea73723          	sd	a0,238(a4) # 920 <freep>
      return (void*)(p + 1);
 ...
 866:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
 86a:	d971                	beqz	a0,83e <malloc+0x98>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 86c:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 86e:	4798                	lw	a4,8(a5)
 870:	fa9775e3          	bgeu	a4,s1,81a <malloc+0x74>
    if(p == freep)
 874:	00093703          	ld	a4,0(s2)
 878:	853e                	mv	a0,a5
 87a:	fef719e3          	bne	a4,a5,86c <malloc+0xc6>
  p = sbrk(nu * sizeof(Header));
 87e:	854e                	mv	a0,s3
 880:	00000097          	auipc	ra,0x0
 884:	b0c080e7          	jalr	-1268(ra) # 38c <sbrk>
  if(p == (char*)-1)
 888:	fd5518e3          	bne	a0,s5,858 <malloc+0xb2>
        return 0;
 88c:	4501                	li	a0,0
 88e:	bf45                	j	83e <malloc+0x98>
