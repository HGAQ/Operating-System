...
main(int argc, char **argv)
{
  ...
  4c:	83058593          	addi	a1,a1,-2000 # 878 <malloc+0xf0>
  50:	4509                	li	a0,2
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4fe:	39ec8c93          	addi	s9,s9,926 # 898 <malloc+0x110>
 ...
 50c:	3e8b8b93          	addi	s7,s7,1000 # 8f0 <digits>
 ...
 632:	26298993          	addi	s3,s3,610 # 890 <malloc+0x108>
        while(*s != 0){
 636:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 714:	1f87b783          	ld	a5,504(a5) # 908 <freep>
 ...
 73c:	00e6ea63          	bltu	a3,a4,750 <free+0x4a>
{
 ...
 77e:	18f73723          	sd	a5,398(a4) # 908 <freep>
}
 782:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7b0:	15c53503          	ld	a0,348(a0) # 908 <freep>
 ...
 7d8:	13490913          	addi	s2,s2,308 # 908 <freep>
  if(p == (char*)-1)
 7dc:	5afd                	li	s5,-1
 7de:	a8a5                	j	856 <malloc+0xce>
    base.s.ptr = freep = prevp = &base;
 7e0:	00000797          	auipc	a5,0x0
 7e4:	12878793          	addi	a5,a5,296 # 908 <freep>
 7e8:	00000717          	auipc	a4,0x0
 7ec:	12870713          	addi	a4,a4,296 # 910 <base>
 7f0:	e398                	sd	a4,0(a5)
 7f2:	e798                	sd	a4,8(a5)
    base.s.size = 0;
 ...
 818:	0ea73a23          	sd	a0,244(a4) # 908 <freep>
      return (void*)(p + 1);
