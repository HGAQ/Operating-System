...
main(int argc, char *argv[])
{
  ...
  1a:	8d258593          	addi	a1,a1,-1838 # 8e8 <malloc+0xee>
  1e:	4509                	li	a0,2
  20:	00000097          	auipc	ra,0x0
  24:	6f4080e7          	jalr	1780(ra) # 714 <fprintf>
    exit(1);
  28:	4505                	li	a0,1
  ...
  8c:	89050513          	addi	a0,a0,-1904 # 918 <malloc+0x11e>
  90:	00000097          	auipc	ra,0x0
  94:	6b2080e7          	jalr	1714(ra) # 742 <printf>
  exit(0);
  98:	4501                	li	a0,0
  ...
  aa:	85a58593          	addi	a1,a1,-1958 # 900 <malloc+0x106>
  ae:	4509                	li	a0,2
  b0:	00000097          	auipc	ra,0x0
  b4:	664080e7          	jalr	1636(ra) # 714 <fprintf>
    exit(1);
  b8:	4505                	li	a0,1
...
putc(int fd, char c)
{
 ...
 480:	f1e080e7          	jalr	-226(ra) # 39a <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4b4:	4e050513          	addi	a0,a0,1248 # 990 <digits>
 4b8:	883a                	mv	a6,a4
 ...
 4d8:	fec7f0e3          	bgeu	a5,a2,4b8 <printint+0x2c>
  if(neg)
 4dc:	00088c63          	beqz	a7,4f4 <printint+0x68>
    buf[i++] = '-';
 ...
 4f0:	0028071b          	addiw	a4,a6,2
  ...
  while(--i >= 0)
 4f4:	02e05663          	blez	a4,520 <printint+0x94>
 4f8:	fc040913          	addi	s2,s0,-64
 4fc:	993a                	add	s2,s2,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 570:	3ccc8c93          	addi	s9,s9,972 # 938 <malloc+0x13e>
 ...
 57e:	416b8b93          	addi	s7,s7,1046 # 990 <digits>
 ...
 5e6:	eaa080e7          	jalr	-342(ra) # 48c <printint>
 5ea:	8b4a                	mv	s6,s2
      } else {
 ...
 63e:	e30080e7          	jalr	-464(ra) # 46a <putc>
  putc(fd, 'x');
 642:	07800593          	li	a1,120
 646:	8556                	mv	a0,s5
 648:	00000097          	auipc	ra,0x0
 64c:	e22080e7          	jalr	-478(ra) # 46a <putc>
 650:	896a                	mv	s2,s10
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 ...
 662:	e0c080e7          	jalr	-500(ra) # 46a <putc>
 ...
 68e:	de0080e7          	jalr	-544(ra) # 46a <putc>
          s++;
 ...
 6a4:	29098993          	addi	s3,s3,656 # 930 <malloc+0x136>
        while(*s != 0){
 6a8:	85ee                	mv	a1,s11
 ...
 6ba:	db4080e7          	jalr	-588(ra) # 46a <putc>
 6be:	8b4a                	mv	s6,s2
      state = 0;
 6c0:	4981                	li	s3,0
 ...
 6cc:	da2080e7          	jalr	-606(ra) # 46a <putc>
      state = 0;
 6d0:	4981                	li	s3,0
 ...
 6dc:	d92080e7          	jalr	-622(ra) # 46a <putc>
        putc(fd, c);
 6e0:	85ca                	mv	a1,s2
 6e2:	8556                	mv	a0,s5
...
free(void *ap)
{
 ...
 786:	2267b783          	ld	a5,550(a5) # 9a8 <freep>
 ...
 7ae:	00e6ea63          	bltu	a3,a4,7c2 <free+0x4a>
{
 ...
 7f0:	1af73e23          	sd	a5,444(a4) # 9a8 <freep>
}
 7f4:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 818:	00148a1b          	addiw	s4,s1,1
 81c:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
 81e:	00000517          	auipc	a0,0x0
 822:	18a53503          	ld	a0,394(a0) # 9a8 <freep>
 ...
 828:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 82a:	4798                	lw	a4,8(a5)
 82c:	04977163          	bgeu	a4,s1,86e <malloc+0x74>
 830:	89d2                	mv	s3,s4
 832:	000a071b          	sext.w	a4,s4
 836:	6685                	lui	a3,0x1
 838:	00d77363          	bgeu	a4,a3,83e <malloc+0x44>
 83c:	6985                	lui	s3,0x1
 83e:	00098b1b          	sext.w	s6,s3
  p = sbrk(nu * sizeof(Header));
 842:	0049999b          	slliw	s3,s3,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
 ...
 84a:	16290913          	addi	s2,s2,354 # 9a8 <freep>
  if(p == (char*)-1)
 84e:	5afd                	li	s5,-1
 850:	a8a5                	j	8c8 <malloc+0xce>
    base.s.ptr = freep = prevp = &base;
 852:	00000797          	auipc	a5,0x0
 856:	15678793          	addi	a5,a5,342 # 9a8 <freep>
 85a:	00000717          	auipc	a4,0x0
 85e:	15670713          	addi	a4,a4,342 # 9b0 <base>
 862:	e398                	sd	a4,0(a5)
 864:	e798                	sd	a4,8(a5)
    base.s.size = 0;
 866:	0007a823          	sw	zero,16(a5)
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 86a:	87ba                	mv	a5,a4
 86c:	b7d1                	j	830 <malloc+0x36>
      if(p->s.size == nunits)
 86e:	02e48c63          	beq	s1,a4,8a6 <malloc+0xac>
        p->s.size -= nunits;
 872:	4147073b          	subw	a4,a4,s4
 876:	c798                	sw	a4,8(a5)
        p += p->s.size;
 ...
 880:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
 882:	0147a423          	sw	s4,8(a5)
      freep = prevp;
 886:	00000717          	auipc	a4,0x0
 88a:	12a73123          	sd	a0,290(a4) # 9a8 <freep>
      return (void*)(p + 1);
 ...
 8ba:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
 8be:	d971                	beqz	a0,892 <malloc+0x98>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8c0:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 8c2:	4798                	lw	a4,8(a5)
 8c4:	fa9775e3          	bgeu	a4,s1,86e <malloc+0x74>
    if(p == freep)
 8c8:	00093703          	ld	a4,0(s2)
 8cc:	853e                	mv	a0,a5
 8ce:	fef719e3          	bne	a4,a5,8c0 <malloc+0xc6>
  p = sbrk(nu * sizeof(Header));
 8d2:	854e                	mv	a0,s3
 8d4:	00000097          	auipc	ra,0x0
 8d8:	b16080e7          	jalr	-1258(ra) # 3ea <sbrk>
  if(p == (char*)-1)
 8dc:	fd5518e3          	bne	a0,s5,8ac <malloc+0xb2>
        return 0;
 8e0:	4501                	li	a0,0
 8e2:	bf45                	j	892 <malloc+0x98>
