...
main(int argc, char *argv[])
{
  ...
  1e:	84e58593          	addi	a1,a1,-1970 # 868 <malloc+0x106>
  22:	4509                	li	a0,2
  24:	00000097          	auipc	ra,0x0
  28:	658080e7          	jalr	1624(ra) # 67c <fprintf>
        exit(1);
  2c:	4505                	li	a0,1
  ...
  3a:	81a58593          	addi	a1,a1,-2022 # 850 <malloc+0xee>
  3e:	4509                	li	a0,2
  40:	00000097          	auipc	ra,0x0
  44:	63c080e7          	jalr	1596(ra) # 67c <fprintf>
        exit(1);
  48:	4505                	li	a0,1
...
0000000000000406 <printint>:
 ...
 42e:	4de50513          	addi	a0,a0,1246 # 908 <digits>
 432:	883a                	mv	a6,a4
...
00000000000004b0 <vprintf>:
 ...
 52e:	38670713          	addi	a4,a4,902 # 8b0 <malloc+0x14e>
 ...
 5b8:	354b8b93          	addi	s7,s7,852 # 908 <digits>
 ...
 60c:	2a090913          	addi	s2,s2,672 # 8a8 <malloc+0x146>
...
00000000000006e0 <free>:
 ...
 6ee:	2367b783          	ld	a5,566(a5) # 920 <freep>
 ...
 758:	1cf73623          	sd	a5,460(a4) # 920 <freep>
 75c:	6422                	ld	s0,8(sp)
...
0000000000000762 <malloc>:
 ...
 78a:	19a53503          	ld	a0,410(a0) # 920 <freep>
 ...
 7b2:	17290913          	addi	s2,s2,370 # 920 <freep>
 7b6:	5afd                	li	s5,-1
 7b8:	a89d                	j	82e <malloc+0xcc>
 7ba:	00000717          	auipc	a4,0x0
 7be:	16670713          	addi	a4,a4,358 # 920 <freep>
 7c2:	00000797          	auipc	a5,0x0
 7c6:	16678793          	addi	a5,a5,358 # 928 <base>
 7ca:	e31c                	sd	a5,0(a4)
 7cc:	e71c                	sd	a5,8(a4)
 ...
 7f0:	12a73a23          	sd	a0,308(a4) # 920 <freep>
