...
main(int argc, char *argv[])
{
  ...
  1e:	86e58593          	addi	a1,a1,-1938 # 888 <malloc+0x104>
  22:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 43e:	4ee50513          	addi	a0,a0,1262 # 928 <digits>
 442:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4fa:	3dac8c93          	addi	s9,s9,986 # 8d0 <malloc+0x14c>
 ...
 508:	424b8b93          	addi	s7,s7,1060 # 928 <digits>
 ...
 62e:	29e98993          	addi	s3,s3,670 # 8c8 <malloc+0x144>
        while(*s != 0){
 632:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 710:	2347b783          	ld	a5,564(a5) # 940 <freep>
 ...
 738:	00e6ea63          	bltu	a3,a4,74c <free+0x4a>
{
 ...
 77a:	1cf73523          	sd	a5,458(a4) # 940 <freep>
}
 77e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7ac:	19853503          	ld	a0,408(a0) # 940 <freep>
 ...
 7d4:	17090913          	addi	s2,s2,368 # 940 <freep>
  if(p == (char*)-1)
 7d8:	5afd                	li	s5,-1
 7da:	a8a5                	j	852 <malloc+0xce>
    base.s.ptr = freep = prevp = &base;
 7dc:	00000797          	auipc	a5,0x0
 7e0:	16478793          	addi	a5,a5,356 # 940 <freep>
 7e4:	00000717          	auipc	a4,0x0
 7e8:	16470713          	addi	a4,a4,356 # 948 <base>
 7ec:	e398                	sd	a4,0(a5)
 7ee:	e798                	sd	a4,8(a5)
    base.s.size = 0;
 ...
 814:	12a73823          	sd	a0,304(a4) # 940 <freep>
      return (void*)(p + 1);
