...
cat(int fd)
{
  ...
  14:	9e090913          	addi	s2,s2,-1568 # 9f0 <buf>
  ...
  44:	8f058593          	addi	a1,a1,-1808 # 930 <malloc+0xee>
  48:	4509                	li	a0,2
  4a:	00000097          	auipc	ra,0x0
  4e:	712080e7          	jalr	1810(ra) # 75c <fprintf>
      exit(1);
  52:	4505                	li	a0,1
  ...
  72:	8da58593          	addi	a1,a1,-1830 # 948 <malloc+0x106>
  76:	4509                	li	a0,2
  78:	00000097          	auipc	ra,0x0
  7c:	6e4080e7          	jalr	1764(ra) # 75c <fprintf>
    exit(1);
  80:	4505                	li	a0,1
...
main(int argc, char *argv[])
{
 ...
 106:	85e58593          	addi	a1,a1,-1954 # 960 <malloc+0x11e>
 10a:	4509                	li	a0,2
 10c:	00000097          	auipc	ra,0x0
 110:	650080e7          	jalr	1616(ra) # 75c <fprintf>
      exit(1);
 114:	4505                	li	a0,1
...
putc(int fd, char c)
{
 ...
 4c8:	f32080e7          	jalr	-206(ra) # 3f6 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4fc:	4e050513          	addi	a0,a0,1248 # 9d8 <digits>
 500:	883a                	mv	a6,a4
 ...
 520:	fec7f0e3          	bgeu	a5,a2,500 <printint+0x2c>
  if(neg)
 524:	00088c63          	beqz	a7,53c <printint+0x68>
    buf[i++] = '-';
 ...
 538:	0028071b          	addiw	a4,a6,2
  ...
  while(--i >= 0)
 53c:	02e05663          	blez	a4,568 <printint+0x94>
 540:	fc040913          	addi	s2,s0,-64
 544:	993a                	add	s2,s2,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5b8:	3ccc8c93          	addi	s9,s9,972 # 980 <malloc+0x13e>
 ...
 5c6:	416b8b93          	addi	s7,s7,1046 # 9d8 <digits>
 ...
 62e:	eaa080e7          	jalr	-342(ra) # 4d4 <printint>
 632:	8b4a                	mv	s6,s2
      } else {
 ...
 686:	e30080e7          	jalr	-464(ra) # 4b2 <putc>
  putc(fd, 'x');
 68a:	07800593          	li	a1,120
 68e:	8556                	mv	a0,s5
 690:	00000097          	auipc	ra,0x0
 694:	e22080e7          	jalr	-478(ra) # 4b2 <putc>
 698:	896a                	mv	s2,s10
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 ...
 6aa:	e0c080e7          	jalr	-500(ra) # 4b2 <putc>
 ...
 6d6:	de0080e7          	jalr	-544(ra) # 4b2 <putc>
          s++;
 ...
 6ec:	29098993          	addi	s3,s3,656 # 978 <malloc+0x136>
        while(*s != 0){
 6f0:	85ee                	mv	a1,s11
 ...
 702:	db4080e7          	jalr	-588(ra) # 4b2 <putc>
 706:	8b4a                	mv	s6,s2
      state = 0;
 708:	4981                	li	s3,0
 ...
 714:	da2080e7          	jalr	-606(ra) # 4b2 <putc>
      state = 0;
 718:	4981                	li	s3,0
 ...
 724:	d92080e7          	jalr	-622(ra) # 4b2 <putc>
        putc(fd, c);
 728:	85ca                	mv	a1,s2
 72a:	8556                	mv	a0,s5
...
free(void *ap)
{
 ...
 7ce:	4267b783          	ld	a5,1062(a5) # bf0 <freep>
 ...
 7f6:	00e6ea63          	bltu	a3,a4,80a <free+0x4a>
{
 ...
 838:	3af73e23          	sd	a5,956(a4) # bf0 <freep>
}
 83c:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 860:	00148a1b          	addiw	s4,s1,1
 864:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
 866:	00000517          	auipc	a0,0x0
 86a:	38a53503          	ld	a0,906(a0) # bf0 <freep>
 ...
 870:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 872:	4798                	lw	a4,8(a5)
 874:	04977163          	bgeu	a4,s1,8b6 <malloc+0x74>
 878:	89d2                	mv	s3,s4
 87a:	000a071b          	sext.w	a4,s4
 87e:	6685                	lui	a3,0x1
 880:	00d77363          	bgeu	a4,a3,886 <malloc+0x44>
 884:	6985                	lui	s3,0x1
 886:	00098b1b          	sext.w	s6,s3
  p = sbrk(nu * sizeof(Header));
 88a:	0049999b          	slliw	s3,s3,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
 ...
 892:	36290913          	addi	s2,s2,866 # bf0 <freep>
  if(p == (char*)-1)
 896:	5afd                	li	s5,-1
 898:	a8a5                	j	910 <malloc+0xce>
    base.s.ptr = freep = prevp = &base;
 89a:	00000797          	auipc	a5,0x0
 89e:	35678793          	addi	a5,a5,854 # bf0 <freep>
 8a2:	00000717          	auipc	a4,0x0
 8a6:	35670713          	addi	a4,a4,854 # bf8 <base>
 8aa:	e398                	sd	a4,0(a5)
 8ac:	e798                	sd	a4,8(a5)
    base.s.size = 0;
 8ae:	0007a823          	sw	zero,16(a5)
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8b2:	87ba                	mv	a5,a4
 8b4:	b7d1                	j	878 <malloc+0x36>
      if(p->s.size == nunits)
 8b6:	02e48c63          	beq	s1,a4,8ee <malloc+0xac>
        p->s.size -= nunits;
 8ba:	4147073b          	subw	a4,a4,s4
 8be:	c798                	sw	a4,8(a5)
        p += p->s.size;
 ...
 8c8:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
 8ca:	0147a423          	sw	s4,8(a5)
      freep = prevp;
 8ce:	00000717          	auipc	a4,0x0
 8d2:	32a73123          	sd	a0,802(a4) # bf0 <freep>
      return (void*)(p + 1);
 ...
 902:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
 906:	d971                	beqz	a0,8da <malloc+0x98>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 908:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 90a:	4798                	lw	a4,8(a5)
 90c:	fa9775e3          	bgeu	a4,s1,8b6 <malloc+0x74>
    if(p == freep)
 910:	00093703          	ld	a4,0(s2)
 914:	853e                	mv	a0,a5
 916:	fef719e3          	bne	a4,a5,908 <malloc+0xc6>
  p = sbrk(nu * sizeof(Header));
 91a:	854e                	mv	a0,s3
 91c:	00000097          	auipc	ra,0x0
 920:	b2a080e7          	jalr	-1238(ra) # 446 <sbrk>
  if(p == (char*)-1)
 924:	fd5518e3          	bne	a0,s5,8f4 <malloc+0xb2>
        return 0;
 928:	4501                	li	a0,0
 92a:	bf45                	j	8da <malloc+0x98>
